  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {courses.map((course) => (
        ...
        >
          {/* Image */}
          <div className={`h-32 rounded-t-xl flex items-center overflow-hidden justify-center relative ${course.color}`}>
            <img src={course.image || course.img} alt={course.title} className="h-full w-full object-cover" />
            {course.featured && (
