      ...
      try {
        ...
        const enhancedCourses = seedData.map((course, index) => {
          ...
          return {
            ...
            projects: 3 + (index % 3),
            color: `from-${
              ["purple", "blue", "green", "pink", "orange", "indigo"][index % 6]
            }-500 to-${
              ["purple", "blue", "green", "pink", "orange", "indigo"][
                (index + 2) % 6
              ]
            }-600`,
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700 transition-colors font-medium"
            >
              Buy Now
            </button>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 py-6">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-600">
                  {searchTerm ? (
                    ...
                    "Try searching for courses, instructors, or categories"
                  )}
                </p>
                {searchTerm && (
                  <button
        ...
        <div className="md:hidden flex justify-center mt-8 pt-6 border-t border-purple-100">
          <Link
            to="/"
            className="flex items-center px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all font-medium shadow-lg"
          >
